...
for activation_p in activations_v:
    for regularization_p in regularizations_v:
        for arch in network_architectures_v:
            for base_rate_p in learning_rates_v:
                ...
                f = open("Data/{}.txt".format(file_num),'w+')
                f.write("{},{},{},{},{},{}\n".format(2,base_rate,50000,100,str(arch),regularization_p,activation_p[0]))
                ...
                for i in range(num_iters):
                    ...
                    if (i+1)%500==0:    
                        ...
                        f.write("{}, {} ,{}\n".format(i+1,round(train_accuracy,3),round(val_accuracy,3)))
                f.close()    
